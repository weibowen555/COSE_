...
# =============================================================================
# COSE canonical training launcher — cose_3b (Qwen/Qwen2.5-3B-Instruct)
# Reconstructed from training-log set-x trace for run "COSE_3B".
...
RUN_NAME=COSE_3B_$(date +%Y%m%d_%H%M%S)
