...
# =============================================================================
# COSE canonical training launcher — cose_0.6b (Qwen/Qwen3-0.6B)
# Reconstructed from training-log set-x trace for run "COSE_0.6B".
...
RUN_NAME=COSE_0.6B_$(date +%Y%m%d_%H%M%S)
...
PYTHONUNBUFFERED=1 python -m absolute_zero_reasoner.main_cose \
    ...
    data.max_validation_prompt_length=8192 \
