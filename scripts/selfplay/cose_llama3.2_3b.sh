...
#SBATCH --qos=gpu
#SBATCH --job-name=cose_llama3.2_3b
...
# =============================================================================
# COSE canonical training launcher — cose_llama3.2_3b (meta-llama/Llama-3.2-3B-Instruct)
# Reconstructed from training-log set-x trace for run "COSE_LLAMA3.2_3B".
...
RUN_NAME=COSE_LLAMA3.2_3B_$(date +%Y%m%d_%H%M%S)
